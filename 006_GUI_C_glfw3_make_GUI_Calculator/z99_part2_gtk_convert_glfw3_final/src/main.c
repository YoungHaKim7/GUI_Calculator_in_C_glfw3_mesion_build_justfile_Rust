...
#include "stb_easy_font.h"  // Include the font rendering library
...
void render(GLFWwindow *window) {
    ...
    // Render the output text using stb_easy_font
    glColor3f(1.0f, 1.0f, 1.0f); // Text color (white)
    static char buffer[99999]; // Buffer for font rendering
    int num_quads = stb_easy_font_print(10, WIN_HEIGHT - 30, output_buffer, NULL, buffer, sizeof(buffer));
